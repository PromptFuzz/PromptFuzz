...
extern "C" int LLVMFuzzerTestOneInput_111(const uint8_t* f_data, size_t f_size) {
    ...
    tjSaveImage("input_file", (unsigned char *)data, size, 0, 0, TJPF_UNKNOWN, fuzz_int32_t_1);
    ...
    result = tjCompress2(compressHandle, srcBuf, width, pitch, height, pixelFormat, &jpegBuf, &jpegSize, TJ_420, fuzz_int32_t_2, fuzz_int32_t_3);
