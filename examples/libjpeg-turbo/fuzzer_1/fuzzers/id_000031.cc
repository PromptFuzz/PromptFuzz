...
extern "C" int LLVMFuzzerTestOneInput_31(const uint8_t* f_data, size_t f_size) {
    ...
    int ret = tj3Compress8(tjh, data, width, fuzz_int32_t_1, height, TJPF_RGB, &compressed_buf, &compressed_size);
    tjDestroy(tjh);
    ...
    ret = tjEncodeYUV3(tjh2, data, jpeg_width, fuzz_int32_t_2, jpeg_height, TJPF_RGB, yuv_buf, 0, TJSAMP_420, fuzz_int32_t_3);
    tjDestroy(tjh2);
