...
extern "C" int LLVMFuzzerTestOneInput_123(const uint8_t* f_data, size_t f_size) {
    ...
    int decompress_result = tjDecompressToYUV2(decompress_handle, jpeg_buf, jpeg_size, yuv_buf, width, align, height, fuzz_int32_t_1);
    ...
    int compress_result = tjCompressFromYUV(compress_handle, yuv_buf, width, align, height, subsamp, &compressed_buf, &compressed_size, fuzz_int32_t_2, fuzz_int32_t_3);
