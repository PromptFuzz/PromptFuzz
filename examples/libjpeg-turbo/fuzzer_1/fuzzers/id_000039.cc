...
extern "C" int LLVMFuzzerTestOneInput_39(const uint8_t* f_data, size_t f_size) {
    ...
    tjDecodeYUVPlanes(tjHandle, (const unsigned char **)&data, NULL, subsamp, dstBuf, width, fuzz_int32_t_1, height, fuzz_int32_t_2, fuzz_int32_t_3);
    char *errorStr = tjGetErrorStr();
    tj3DecompressToYUV8(tjHandle, data, size, dstBuf, fuzz_int32_t_4);
    tj3SaveImage8(tjHandle, "output_file", dstBuf, width, fuzz_int32_t_5, height, fuzz_int32_t_6);
