...
extern "C" int LLVMFuzzerTestOneInput_84(const uint8_t* f_data, size_t f_size)
{
    ...
    short *image_buffer = tj3LoadImage12(nullptr, "input_file", &width, fuzz_int32_t_1, &height, &pixelFormat);
    ...
    result = tj3Decompress16(transform_handle, nullptr, 0, nullptr, fuzz_int32_t_2, pixelFormat);
