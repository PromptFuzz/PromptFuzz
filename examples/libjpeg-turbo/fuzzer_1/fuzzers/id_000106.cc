...
extern "C" int LLVMFuzzerTestOneInput_106(const uint8_t* f_data, size_t f_size) {
    ...
    tj3EncodeYUV8(tjHandle, srcBuf, width, width, height, pixelSize, dstBuf, fuzz_int32_t_2);
    ...
    tjCompressFromYUV(tjHandle, dstBuf, width, fuzz_int32_t_3, height, jpegSubsamp, &jpegBufOut, &jpegSizeOut, fuzz_int32_t_4, fuzz_int32_t_5);
