...
extern "C" int LLVMFuzzerTestOneInput_16(const uint8_t* f_data, size_t f_size) {
    ...
    unsigned char *srcBuf = tjLoadImage("input_file.jpg", &width, fuzz_int32_t_1, &height, &pixelSize, fuzz_int32_t_2);

    // Compress image
    tjCompress(handle, srcBuf, width, fuzz_int32_t_3, height, pixelSize, jpegBuf, &jpegSize, TJSAMP_444, fuzz_int32_t_4, 0);
