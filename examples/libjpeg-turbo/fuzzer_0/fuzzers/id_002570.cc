...
extern "C" int LLVMFuzzerTestOneInput_63(const uint8_t *data, size_t size) {
  ...
  unsigned char *input_image = tj3LoadImage8(NULL, "input.jpg", &width, 4, &height, &pixelFormat);
  ...
  int align = 4;
  size_t yuv_size = tj3YUVBufSize(width, align, height, 0);
  ...
  result = tj3SaveImage12(NULL, output_file, output_image, output_width, 4, output_height, output_pixelFormat);
