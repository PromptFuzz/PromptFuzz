...
void  id_000107_decompressJPEG(const uint8_t *jpegData, size_t jpegSize, uint8_t *outputData, int width, int height, int pixelSize) {
...
extern "C" int LLVMFuzzerTestOneInput_6(const uint8_t *data, size_t size) {
    ...
    // Decompress the JPEG image
     id_000107_decompressJPEG(inputData, inputFileSize, outputData, width, height, 3);
