...
extern "C" int LLVMFuzzerTestOneInput_72(const uint8_t *data, size_t size) {
    ...
    tj3EncodeYUVPlanes8(handle, data, /*width=*/0, /*pitch=*/0, /*height=*/0, /*pixelFormat=*/0, nullptr, nullptr);

    // Save image using tj3SaveImage12
    tj3SaveImage12(handle, "output_file", nullptr, /*width=*/0, /*pitch=*/0, /*height=*/0, /*pixelFormat=*/0);

    // Get the value of a parameter
    paramValue = tj3Get(handle, /*param=*/0);
