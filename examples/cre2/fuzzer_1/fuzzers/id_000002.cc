...
extern "C" int LLVMFuzzerTestOneInput_2(const uint8_t* f_data, size_t f_size) {
    ...
    cre2_opt_set_literal(opt, fuzz_int32_t_1);
    cre2_opt_set_word_boundary(opt, fuzz_int32_t_2);
    ...
    cre2_regexp_t *rex = cre2_new(fuzz_str_3, static_cast<int>(fuzz_str_sz_3), opt);
