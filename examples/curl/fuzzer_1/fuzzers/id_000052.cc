...
size_t  id_000052_handle_received_data(void *buffer, size_t size, size_t nmemb, void *userp) {
...
extern "C" int LLVMFuzzerTestOneInput_52(const uint8_t* f_data, size_t f_size) {
    ...
    curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION,  id_000052_handle_received_data);
