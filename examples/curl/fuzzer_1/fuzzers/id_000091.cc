...
size_t  id_000091_write_data(void *ptr, size_t size, size_t nmemb, FILE *stream) {
...
extern "C" int LLVMFuzzerTestOneInput_91(const uint8_t* f_data, size_t f_size) {
    ...
    curl_mime_name(field, fuzz_str_3);
    curl_mime_data(field, fuzz_str_4, static_cast<size_t>(fuzz_str_sz_4));
    ...
    curl_mfprintf(request_file, "\r\n");
     id_000091_write_data((void *)data, size, 1, request_file);
