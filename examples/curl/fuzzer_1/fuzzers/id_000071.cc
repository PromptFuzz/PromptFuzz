...
static size_t  id_000071_write_data_callback(void* ptr, size_t size, size_t nmemb, FILE* stream) {
...
extern "C" int LLVMFuzzerTestOneInput_71(const uint8_t* f_data, size_t f_size) {
    ...
    curl_easy_setopt(curl_handle, CURLOPT_WRITEFUNCTION,  id_000071_write_data_callback);
