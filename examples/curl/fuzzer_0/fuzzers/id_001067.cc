...
static size_t  id_001067_WriteToFile(void *buffer, size_t size, size_t nmemb, void *userdata) {
...
extern "C" int LLVMFuzzerTestOneInput_58(const uint8_t *data, size_t size) {
    ...
    curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION,  id_001067_WriteToFile);
