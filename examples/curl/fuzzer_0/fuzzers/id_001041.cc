...
size_t  id_001041_read_callback(char *buffer, size_t size, size_t nmemb, void *userdata)
{
...
extern "C" int LLVMFuzzerTestOneInput_55(const uint8_t *data, size_t size)
{
    ...
    curl_mime_data_cb(part_handle, size,  id_001041_read_callback, NULL, NULL, NULL);
