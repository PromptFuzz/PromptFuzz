...
extern "C" int LLVMFuzzerTestOneInput_7(const uint8_t* f_data, size_t f_size) {
    ...
    aom_codec_err_t codec_ctrl_err = aom_codec_control(NULL, fuzz_int32_t_1);
    const char* codec_version_str = aom_codec_version_str();
    aom_fixed_buf_t buffers;
    aom_codec_err_t set_buf_err = aom_codec_set_cx_data_buf(NULL, &buffers, 0, fuzz_uint32_t_2);
    ...
    // Create an image
    aom_image_t img_obj;
    aom_img_alloc(&img_obj, AOM_IMG_FMT_I420, fuzz_uint32_t_3, fuzz_uint32_t_4, 16);

    // Set a rectangular region of the image
    aom_img_set_rect(&img_obj, fuzz_uint32_t_5, fuzz_uint32_t_6, fuzz_uint32_t_7, fuzz_uint32_t_8, fuzz_uint32_t_9);
