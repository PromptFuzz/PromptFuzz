...
extern "C" int LLVMFuzzerTestOneInput_16(const uint8_t* f_data, size_t f_size) {
    ...
    aom_codec_dec_init_ver(&codec_ctx, codec_iface, &codec_cfg, fuzz_int64_t_1, AOM_DECODER_ABI_VERSION);
    ...
    aom_codec_set_cx_data_buf(&codec_ctx, &encoded_buf, 0, fuzz_uint32_t_2);
    
    // Step 6: Set default encoder configuration
    aom_codec_enc_cfg_t enc_cfg;
    aom_codec_enc_config_default(codec_iface, &enc_cfg, fuzz_uint32_t_3);
