...
extern "C" int LLVMFuzzerTestOneInput_58(const uint8_t* f_data, size_t f_size) {
    ...
    aom_codec_dec_init_ver(&codec, codec_iface, &codec_cfg, fuzz_int64_t_1, AOM_DECODER_ABI_VERSION);
    ...
    aom_codec_enc_init_ver(&enc_codec, aom_codec_av1_cx(), &enc_cfg, fuzz_int64_t_2, AOM_ENCODER_ABI_VERSION);
