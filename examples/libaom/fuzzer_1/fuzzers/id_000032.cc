...
extern "C" int LLVMFuzzerTestOneInput_32(const uint8_t* f_data, size_t f_size) {
    ...
    aom_codec_enc_config_default(codec_iface, &enc_cfg, fuzz_uint32_t_1);
    ...
    aom_codec_enc_init_ver(&codec_ctx, codec_iface, &enc_cfg, fuzz_int64_t_2, AOM_ENCODER_ABI_VERSION);
