...
extern "C" int LLVMFuzzerTestOneInput_14(const uint8_t* f_data, size_t f_size) {
    ...
    aom_codec_enc_config_default(aom_codec_av1_cx(), &cfg, fuzz_uint32_t_1);
    aom_codec_enc_init_ver(&encoder, aom_codec_av1_cx(), &cfg, fuzz_int64_t_2, AOM_ENCODER_ABI_VERSION);
    ...
    // Set input buffer
    aom_codec_set_cx_data_buf(&encoder, &input_buf, 0, fuzz_uint32_t_3);

    // Encode frame
    aom_codec_encode(&encoder, NULL, fuzz_int64_t_4, fuzz_uint64_t_5, fuzz_int64_t_6);
