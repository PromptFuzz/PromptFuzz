...
extern "C" int LLVMFuzzerTestOneInput_20(const uint8_t* f_data, size_t f_size) {
    ...
    aom_codec_err_t encoder_cfg_result = aom_codec_enc_config_default(encoder_iface, &encoder_cfg, fuzz_uint32_t_1);
    ...
    aom_codec_err_t decoder_init_result = aom_codec_dec_init_ver(&decoder, decoder_iface, NULL, fuzz_int64_t_2, AOM_DECODER_ABI_VERSION);
    ...
    aom_codec_err_t encoder_init_result = aom_codec_enc_init_ver(encoder_ctx, encoder_iface, &encoder_cfg, fuzz_int64_t_3, AOM_ENCODER_ABI_VERSION);
