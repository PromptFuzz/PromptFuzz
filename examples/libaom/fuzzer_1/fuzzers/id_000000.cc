...
extern "C" int LLVMFuzzerTestOneInput_0(const uint8_t* f_data, size_t f_size) {
    ...
    aom_codec_err_t encoder_init_result = aom_codec_enc_init_ver(
            &encoder_ctx, encoder_iface, &encoder_cfg, fuzz_int64_t_2, AOM_ENCODER_ABI_VERSION
    );
    ...
    // Encode the frame
    aom_codec_encode(&encoder_ctx, frame, fuzz_int64_t_3, fuzz_uint64_t_4, fuzz_int64_t_5);
