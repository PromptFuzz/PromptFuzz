...
extern "C" int LLVMFuzzerTestOneInput_19(const uint8_t *data, size_t size) {
    ...
    aom_codec_dec_init_ver(&decoder, aom_codec_av1_dx(), &dec_cfg, 0, AOM_DECODER_ABI_VERSION);
    ...
    aom_image_t image;
    aom_img_alloc_with_border(&image, AOM_IMG_FMT_I420, enc_cfg.g_w, enc_cfg.g_h, 16, 32, 8);
    ...
    aom_codec_encode(&encoder, &image, 0, 0, 0);
