...
extern "C" int LLVMFuzzerTestOneInput_41(const uint8_t *data, size_t size) {
    ...
    uleb_size = aom_uleb_size_in_bytes(42);
    iface_name = aom_codec_iface_name(NULL);
    image = aom_img_wrap(NULL, AOM_IMG_FMT_I420, 1920, 1080, 1, NULL);
    metadata = aom_img_metadata_alloc(1, data, size, AOM_MIF_KEY_FRAME);
