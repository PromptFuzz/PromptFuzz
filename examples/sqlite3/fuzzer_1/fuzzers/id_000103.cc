...
extern "C" int LLVMFuzzerTestOneInput_103(const uint8_t* f_data, size_t f_size) {
    ...
    sqlite3_status(fuzz_int32_t_2, &status, NULL, fuzz_int32_t_3);
    ...
    compileOption = sqlite3_compileoption_get(fuzz_int32_t_4);
