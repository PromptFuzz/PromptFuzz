...
extern "C" int LLVMFuzzerTestOneInput_124(const uint8_t* f_data, size_t f_size) {
    ...
    const char *compileOption = sqlite3_compileoption_get(fuzz_int32_t_1);
    ...
    int createModuleResult = sqlite3_create_module(db, fuzz_str_2, module, nullptr);
    sqlite3_blob *blob = nullptr;
    sqlite3_int64 row = 0;
    int blobReopenResult = sqlite3_blob_reopen(blob, fuzz_int64_t_3);
