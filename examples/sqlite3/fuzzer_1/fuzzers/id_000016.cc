...
extern "C" int LLVMFuzzerTestOneInput_16(const uint8_t* f_data, size_t f_size) {
    ...
    sqlite3_blob_write(NULL, NULL, 0, fuzz_int32_t_1);
    sqlite3 *db;
    sqlite3_db_status(db, fuzz_int32_t_2, NULL, NULL, fuzz_int32_t_3);
    sqlite3_int64 heap_limit = sqlite3_hard_heap_limit64(fuzz_int64_t_4);
    const char *db_filename = sqlite3_db_filename(db, NULL);
    sqlite3_interrupt(db);
    sqlite3_memory_alarm(NULL, NULL, fuzz_int64_t_5);
