...
extern "C" int LLVMFuzzerTestOneInput_41(const uint8_t* f_data, size_t f_size) {
	...
	//fuzzer vars shim {
		...
		FDPConsumeRandomLengthString(unsigned char, fuzz_str_5, fuzz_str_sz_5, fdp);
    ...
    sqlite3_bind_text16(stmt, fuzz_int32_t_3, fuzz_str_2, fuzz_int32_t_4, nullptr);
    sqlite3_bind_blob64(stmt, fuzz_int32_t_6, fuzz_str_5, static_cast<sqlite3_uint64>(fuzz_str_sz_5), nullptr);
