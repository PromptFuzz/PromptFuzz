...
extern "C" int LLVMFuzzerTestOneInput_20(const uint8_t* f_data, size_t f_size) {
    ...
    sqlite3_blob_open(db, dbFilename, "table", "column", fuzz_int64_t_1, fuzz_int32_t_2, &blob);
    ...
    dbStatus = sqlite3_db_status(db, fuzz_int32_t_5, &curStatus, &hiwtrStatus, fuzz_int32_t_6);
    
    // Step 10: Call the sqlite3_enable_load_extension API
    loadExt = sqlite3_enable_load_extension(db, fuzz_int32_t_7);
    ...
    mutex = sqlite3_mutex_alloc(fuzz_int32_t_9);
