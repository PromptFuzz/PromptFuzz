...
extern "C" int LLVMFuzzerTestOneInput_106(const uint8_t* f_data, size_t f_size) {
    ...
    sqlite3_status(fuzz_int32_t_2, &current_status, &highwater_status, fuzz_int32_t_3);
    ...
    sqlite3_create_function16(db, u"custom_function", fuzz_int32_t_4, fuzz_int32_t_5, NULL,
