...
extern "C" int LLVMFuzzerTestOneInput_92(const uint8_t* f_data, size_t f_size) {
    ...
    result = sqlite3_bind_blob(nullptr, fuzz_int32_t_2, fuzz_str_1, static_cast<int>(fuzz_str_sz_1), nullptr);
    int keyword_count = sqlite3_keyword_count();
    sqlite3_create_collation_v2(db, nullptr, fuzz_int32_t_3, nullptr, nullptr, nullptr);
