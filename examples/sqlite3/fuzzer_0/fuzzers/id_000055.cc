...
extern "C" int LLVMFuzzerTestOneInput_55(const uint8_t *data, size_t size) {
    ...
    void *profile_data;
    int enable_extension = sqlite3_enable_load_extension(db, 1); // Enable loading extension
    int disable_extension = sqlite3_enable_load_extension(db, 0); // Disable loading extension
