...
extern "C" int LLVMFuzzerTestOneInput_99(const uint8_t *data, size_t size) {
    ...
    int primaryKey;
    int autoinc;
    sqlite3_table_column_metadata(db, nullptr, tableName, nullptr, &dataType, &collSeq, &notNull, &primaryKey, &autoinc);

    // Use sqlite3_create_module_v2 API
    sqlite3_create_module_v2(db, "CustomModule", nullptr, nullptr, nullptr);
