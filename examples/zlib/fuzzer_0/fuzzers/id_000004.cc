...
extern "C" int LLVMFuzzerTestOneInput_4(const uint8_t *data, size_t size) {
    ...
    gzFile gz_file = gzdopen(in_fd, "rb");
    gzsetparams(gz_file, Z_DEFAULT_COMPRESSION, Z_DEFAULT_STRATEGY);
    ...
    z_size_t size_written = gzfwrite(str, sizeof(char), strlen(str), gz_file);
