...
extern "C" int LLVMFuzzerTestOneInput_1(const uint8_t *data, size_t size) {
    ...
    gzFile gz_input_file = gzopen64(input_file, "rb");
    ...
    off64_t seek_pos = gzseek64(gz_input_file, 0, SEEK_SET);
    ...
    gzFile gz_output_file = gzopen64(output_file, "wb");
    ...
    int windowBits = 15;
    int reset_result = inflateReset2(&strm, windowBits);
