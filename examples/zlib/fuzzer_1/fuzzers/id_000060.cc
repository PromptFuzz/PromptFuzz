...
extern "C" int LLVMFuzzerTestOneInput_60(const uint8_t* f_data, size_t f_size) {
    ...
    ret = inflateInit_(&strm, fuzz_str_1, sizeof(z_stream));
    if (ret != Z_OK) {
        // Handle error
    ...
    gzFile input_file = gzopen("input_file", fuzz_str_2);
    gzsetparams(input_file, fuzz_int32_t_3, fuzz_int32_t_4);
    ...
    while (true) {
        ...
        do {
            ...
            ret = inflate(&strm, fuzz_int32_t_5);
