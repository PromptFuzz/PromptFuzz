...
extern "C" int LLVMFuzzerTestOneInput_15(const uint8_t* f_data, size_t f_size) {
  ...
  deflateInit2_(&deflate_strm, fuzz_int32_t_2, fuzz_int32_t_3, MAX_WBITS + 16, fuzz_int32_t_4, fuzz_int32_t_5, fuzz_str_1, sizeof(z_stream));
  ...
  inflateInit2_(&inflate_strm, MAX_WBITS + 16, fuzz_str_6, sizeof(z_stream));
  ...
  do {
    ...
    inflate(&inflate_strm, fuzz_int32_t_7);
