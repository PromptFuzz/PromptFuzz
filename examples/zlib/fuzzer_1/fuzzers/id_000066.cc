...
extern "C" int LLVMFuzzerTestOneInput_66(const uint8_t* f_data, size_t f_size) {
    ...
    while (!gzeof(input_gzfile)) {
        ...
        gzbuffer(output_gzfile, fuzz_uint32_t_1);
    ...
    deflateTune(&strm, fuzz_int32_t_2, fuzz_int32_t_3, fuzz_int32_t_4, fuzz_int32_t_5);
    inflateSync(&strm);
    gzflush(output_gzfile, fuzz_int32_t_6);
