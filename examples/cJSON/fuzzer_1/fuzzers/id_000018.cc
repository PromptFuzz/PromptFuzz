...
extern "C" int LLVMFuzzerTestOneInput_18(const uint8_t* f_data, size_t f_size) {
	...
	//fuzzer vars shim {
		...
		const char * fuzzer_var_cJSON_CreateStringArray_5_0[2] = {fuzz_str_1,fuzz_str_2};//fuzzer shim end}
    ...
    cJSON *newItem = cJSON_CreateStringArray(fuzzer_var_cJSON_CreateStringArray_5_0, 2);
