...
extern "C" int LLVMFuzzerTestOneInput_30(const uint8_t* f_data, size_t f_size) {
    ...
    cJSON *formatObject = cJSON_GetObjectItemCaseSensitive(root, fuzz_str_1);
    ...
    cJSON *typeValue = cJSON_GetObjectItemCaseSensitive(formatObject, fuzz_str_2);
    ...
    cJSON *newTypeValue = cJSON_CreateString(fuzz_str_3);
    ...
    cJSON_AddFalseToObject(root, fuzz_str_4);
