...
extern "C" int LLVMFuzzerTestOneInput_13(const uint8_t *data, size_t size) {
  ...
  ares_gethostbyname(channel, "example.com", AF_INET, host_cb, nullptr);
  ...
  ares_parse_ptr_reply(buf, bytes_read, nullptr, 0, AF_INET, &host);
  ...
  ares_search(channel, "example.com", ns_c_in, ns_t_a, cb, nullptr);
