...
extern "C" int LLVMFuzzerTestOneInput_20(const uint8_t* f_data, size_t f_size) {
    ...
    // Get host by address
    ares_gethostbyaddr(channel, nullptr, 0, fuzz_int32_t_1, host_callback, nullptr);
    ...
    // Get nameinfo
    ares_getnameinfo(channel, sa_ptr, sizeof(sa), fuzz_int32_t_2, nameinfo_callback, nullptr);
