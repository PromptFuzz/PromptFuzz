...
extern "C" int LLVMFuzzerTestOneInput_10(const uint8_t* f_data, size_t f_size) {
    ...
    ares_mkquery(fuzz_str_1, fuzz_int32_t_2, fuzz_int32_t_3, fuzz_uint16_t_4, fuzz_int32_t_5, &query_buffer, &query_buffer_length);
    ...
    ares_set_servers_csv(channel, fuzz_str_6);
