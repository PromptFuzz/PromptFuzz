...
extern "C" int LLVMFuzzerTestOneInput_30(const uint8_t *data, size_t size) {
    ...
    // Initialize encoder
    vpx_codec_enc_init_ver(&encoder, encoder_iface, nullptr, 0, VPX_ENCODER_ABI_VERSION);
    ...
    vpx_codec_set_cx_data_buf(&encoder, &data_buf, 0, 0);
    ...
    // Encode image
    vpx_image_t image;
    vpx_codec_encode(&encoder, &image, 0, 0, 0, 0);
