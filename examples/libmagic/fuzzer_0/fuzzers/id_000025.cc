...
extern "C" int LLVMFuzzerTestOneInput_25(const uint8_t *data, size_t size) {
    ...
    vpx_codec_set_cx_data_buf(&encoder_ctx, &compressed_data_buf, 0, 0);

    // Create a VP8 codec context for decoding
    vpx_codec_ctx_t decoder_ctx;
    vpx_codec_err_t decoder_err = vpx_codec_dec_init_ver(&decoder_ctx, decoder_iface, nullptr, 0, VPX_DECODER_ABI_VERSION);
