...
extern "C" int LLVMFuzzerTestOneInput_53(const uint8_t* f_data, size_t f_size) {
    ...
    vpx_codec_enc_config_default(vpx_codec_vp9_cx_iface, &enc_cfg, fuzz_uint32_t_1);
    vpx_codec_ctx_t ctx;
    vpx_codec_enc_init_ver(&ctx, vpx_codec_vp9_cx_iface, &enc_cfg, fuzz_int64_t_2, VPX_ENCODER_ABI_VERSION);
