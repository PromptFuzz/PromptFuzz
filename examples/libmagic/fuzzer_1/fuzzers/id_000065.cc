...
extern "C" int LLVMFuzzerTestOneInput_65(const uint8_t* f_data, size_t f_size) {
    ...
    vpx_codec_err_t decoder_init_err = vpx_codec_dec_init_ver(
        &decoder_ctx, decoder_iface, &decoder_cfg, fuzz_int64_t_1, decoder_ver);
    ...
    vpx_codec_err_t encoder_init_err = vpx_codec_enc_init_ver(
        &encoder_ctx, encoder_iface, &encoder_cfg, fuzz_int64_t_3, VPX_ENCODER_ABI_VERSION);
    ...
    vpx_codec_err_t encode_err = vpx_codec_encode(
        &encoder_ctx, image, fuzz_int64_t_4, fuzz_uint64_t_5, fuzz_int64_t_6, fuzz_uint64_t_7);
