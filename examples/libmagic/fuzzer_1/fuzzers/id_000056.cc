...
extern "C" int LLVMFuzzerTestOneInput_56(const uint8_t* f_data, size_t f_size) {
    ...
    vpx_codec_enc_config_default(vpx_codec_vp8_cx(), &encoder_cfg, fuzz_uint32_t_1);
    // Initialize encoder
    ...
    vpx_codec_encode(&encoder, raw_frame, fuzz_int64_t_2, fuzz_uint64_t_3, fuzz_int64_t_4, fuzz_uint64_t_5);
    ...
    vpx_codec_decode(&decoder, output_data, size, nullptr, fuzz_int64_t_6);
