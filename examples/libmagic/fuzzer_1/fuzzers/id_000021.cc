...
extern "C" int LLVMFuzzerTestOneInput_21(const uint8_t* f_data, size_t f_size) {
    ...
    vpx_image_t img;
    vpx_img_wrap(&img, VPX_IMG_FMT_I420, 1280, 720, fuzz_uint32_t_1, NULL);
    ...
    vpx_codec_enc_config_default(iface, &cfg, fuzz_uint32_t_2);
    vpx_codec_enc_init_ver(&ctx, iface, &cfg, fuzz_int64_t_3, fuzz_int32_t_4);
    vpx_codec_pts_t pts = 0;
    vpx_codec_encode(&ctx, &img, fuzz_int64_t_5, fuzz_uint64_t_6, fuzz_int64_t_7, fuzz_uint64_t_8);
