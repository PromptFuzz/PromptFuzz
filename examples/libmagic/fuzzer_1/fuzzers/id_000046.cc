...
extern "C" int LLVMFuzzerTestOneInput_46(const uint8_t* f_data, size_t f_size) {
    ...
    vpx_codec_encode(&encoder_ctx, &input_image, fuzz_int64_t_3, fuzz_uint64_t_4, fuzz_int64_t_5, fuzz_uint64_t_6);
    ...
    vpx_codec_dec_init_ver(&decoder_ctx, decoder_iface, &decoder_cfg, fuzz_int64_t_7, VPX_DECODER_ABI_VERSION);
    ...
    vpx_codec_encode(&encoder_ctx, &input_image, fuzz_int64_t_8, fuzz_uint64_t_9, fuzz_int64_t_10, fuzz_uint64_t_11);
