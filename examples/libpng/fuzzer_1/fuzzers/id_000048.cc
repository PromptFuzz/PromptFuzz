...
extern "C" int LLVMFuzzerTestOneInput_48(const uint8_t* f_data, size_t f_size) {
    ...
    png_set_cHRM_fixed(png_ptr, info_ptr, fuzz_int32_t_1, fuzz_int32_t_2, fuzz_int32_t_3, fuzz_int32_t_4, fuzz_int32_t_5, fuzz_int32_t_6, fuzz_int32_t_7, fuzz_int32_t_8);
    
    png_set_interlace_handling(png_ptr);
    
    png_permit_mng_features(png_ptr, fuzz_uint32_t_9);
