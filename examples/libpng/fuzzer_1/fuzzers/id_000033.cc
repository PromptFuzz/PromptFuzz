...
extern "C" int LLVMFuzzerTestOneInput_33(const uint8_t* f_data, size_t f_size) {
    ...
    // Set CRC action
    png_set_crc_action(png_ptr, fuzz_int32_t_2, fuzz_int32_t_3);
    ...
    // Set filter
    png_set_filter(png_ptr, fuzz_int32_t_4, fuzz_int32_t_5);
    ...
    // Get valid flags
    png_uint_32 valid_flags = png_get_valid(png_ptr, info_ptr, fuzz_uint32_t_6);
