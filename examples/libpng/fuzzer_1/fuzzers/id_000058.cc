...
extern "C" int LLVMFuzzerTestOneInput_58(const uint8_t* f_data, size_t f_size) {
    ...
    png_set_background(png_ptr, &background_color, fuzz_int32_t_2, fuzz_int32_t_3, 0.45);

    int unit;
    png_charp swidth, sheight;
    png_get_sCAL_s(png_ptr, info_ptr, &unit, &swidth, &sheight);

    png_chunk_warning(png_ptr, fuzz_str_4);
    ...
    png_uint_32 mng_features_permitted = png_permit_mng_features(png_ptr, fuzz_uint32_t_5);
