...
extern "C" int LLVMFuzzerTestOneInput_54(const uint8_t* f_data, size_t f_size) {
    ...
    png_set_alpha_mode(png_ptr, fuzz_int32_t_2, 1.0);
    png_voidp user_transform_ptr = png_get_user_transform_ptr(png_ptr);

    png_set_check_for_invalid_index(png_ptr, fuzz_int32_t_3);
    ...
    png_set_rgb_to_gray_fixed(png_ptr, fuzz_int32_t_4, fuzz_int32_t_5, fuzz_int32_t_6);
