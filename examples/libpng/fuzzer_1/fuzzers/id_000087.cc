...
extern "C" int LLVMFuzzerTestOneInput_87(const uint8_t* f_data, size_t f_size) {
    ...
    png_structp png_read_ptr = png_create_read_struct_2(fuzz_str_1, NULL, NULL, NULL, NULL, NULL, NULL);
    ...
    png_structp png_write_ptr = png_create_write_struct(fuzz_str_2, NULL, NULL, NULL);
    ...
    // Set invalid flag
    png_set_invalid(png_read_ptr, NULL, fuzz_int32_t_3);
