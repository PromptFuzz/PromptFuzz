...
extern "C" int LLVMFuzzerTestOneInput_109(const uint8_t* f_data, size_t f_size) {
    ...
    png_structp png_read_ptr = png_create_read_struct(fuzz_str_1, NULL, NULL, NULL);
    ...
    png_set_sig_bytes(png_read_ptr, fuzz_int32_t_2);

    // Step 12: Read the PNG image
    png_read_png(png_read_ptr, png_info_ptr, fuzz_int32_t_3, NULL);
    ...
    png_structp png_write_ptr = png_create_write_struct(fuzz_str_4, NULL, NULL, NULL);
