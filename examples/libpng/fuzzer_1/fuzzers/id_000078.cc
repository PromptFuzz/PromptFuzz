...
extern "C" int LLVMFuzzerTestOneInput_78(const uint8_t* f_data, size_t f_size) {
    ...
    png_set_compression_window_bits(nullptr, fuzz_int32_t_1);
    size_t processed_data = png_process_data_pause(nullptr, fuzz_int32_t_2);
    png_set_pHYs(nullptr, nullptr, fuzz_uint32_t_3, fuzz_uint32_t_4, fuzz_int32_t_5);
    png_alloc_size_t malloc_max = png_get_chunk_malloc_max(nullptr);
    png_set_read_user_chunk_fn(nullptr, nullptr, nullptr);
    png_set_text_compression_method(nullptr, fuzz_int32_t_6);
    png_time mod_time;
    png_convert_from_time_t(&mod_time, time(nullptr));
    int option_status = png_set_option(nullptr, fuzz_int32_t_7, fuzz_int32_t_8);
