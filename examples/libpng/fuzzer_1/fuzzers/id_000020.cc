...
extern "C" int LLVMFuzzerTestOneInput_20(const uint8_t* f_data, size_t f_size) {
    ...
    png_struct *png_ptr = png_create_read_struct(fuzz_str_1, nullptr, nullptr, nullptr);
    if (png_ptr == nullptr) {
        assert_file_closed(&in_file);;
        assert_file_name_closed("input_file");
	assert_file_closed(&input);
    ...
    png_set_iCCP(png_ptr, info_ptr, nullptr, fuzz_int32_t_2, nullptr, 0);
    png_set_compression_mem_level(png_ptr, fuzz_int32_t_3);
