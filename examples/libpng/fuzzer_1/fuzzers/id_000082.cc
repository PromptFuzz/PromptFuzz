...
extern "C" int LLVMFuzzerTestOneInput_82(const uint8_t* f_data, size_t f_size) {
    ...
    png_set_filler(nullptr, fuzz_uint32_t_1, fuzz_int32_t_2);
    ...
    png_byte buf[4];
    png_save_uint_32(buf, fuzz_uint32_t_3);
    png_image image;
    png_image_finish_read(&image, nullptr, nullptr, fuzz_int32_t_4, nullptr);
