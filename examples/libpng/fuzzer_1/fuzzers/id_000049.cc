...
extern "C" int LLVMFuzzerTestOneInput_49(const uint8_t* f_data, size_t f_size) {
    ...
    // Set data freer
    png_data_freer(png_ptr, info_ptr, PNG_USER_WILL_FREE_DATA, fuzz_uint32_t_3);

    // Set cHRM XYZ fixed
    png_set_cHRM_XYZ_fixed(png_ptr, info_ptr, fuzz_int32_t_4, fuzz_int32_t_5, fuzz_int32_t_6, fuzz_int32_t_7, fuzz_int32_t_8, fuzz_int32_t_9, fuzz_int32_t_10, fuzz_int32_t_11, fuzz_int32_t_12);

    // Set sCAL fixed
    png_set_sCAL_fixed(png_ptr, info_ptr, 1, fuzz_int32_t_13, fuzz_int32_t_14);
