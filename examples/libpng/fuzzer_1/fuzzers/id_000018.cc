...
extern "C" int LLVMFuzzerTestOneInput_18(const uint8_t* f_data, size_t f_size) {
    ...
    png_read_ptr = png_create_read_struct(fuzz_str_1, NULL, NULL, NULL);
    png_write_ptr = png_create_write_struct(fuzz_str_2, NULL, NULL, NULL);
    ...
    png_image_finish_read(&image, NULL, NULL, fuzz_int32_t_3, NULL);
