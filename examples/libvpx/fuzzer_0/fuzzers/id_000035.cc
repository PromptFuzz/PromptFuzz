...
extern "C" int LLVMFuzzerTestOneInput_35(const uint8_t *data, size_t size) {
  ...
  vpx_codec_dec_init_ver(&codec_ctx, vpx_codec_vp9_dx(), &cfg, 0, VPX_DECODER_ABI_VERSION);
  ...
  vpx_image_t image;
  vpx_img_wrap(&image, VPX_IMG_FMT_I420, enc_cfg.g_w, enc_cfg.g_h, 1, nullptr);

  // Set the rectangle of the image
  vpx_img_set_rect(&image, 0, 0, enc_cfg.g_w, enc_cfg.g_h);
