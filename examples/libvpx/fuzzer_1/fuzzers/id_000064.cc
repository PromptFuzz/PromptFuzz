...
extern "C" int LLVMFuzzerTestOneInput_64(const uint8_t* f_data, size_t f_size) {
    ...
    vpx_codec_err_t decoder_init_result = vpx_codec_dec_init_ver(&decoder, decoder_interface, &decoder_config, fuzz_int64_t_1, VPX_DECODER_ABI_VERSION);
    ...
    vpx_codec_enc_config_default(encoder_interface, &encoder_config, fuzz_uint32_t_2);
    vpx_codec_enc_init_ver(&encoder, encoder_interface, &encoder_config, fuzz_int64_t_3, VPX_ENCODER_ABI_VERSION);
    ...
    vpx_codec_encode(&encoder, NULL, fuzz_int64_t_4, fuzz_uint64_t_5, fuzz_int64_t_6, fuzz_uint64_t_7);
    
    // Step 11: Decode the encoded data
    vpx_codec_err_t decode_result = vpx_codec_decode(&decoder, NULL, 0, NULL, fuzz_int64_t_8);
