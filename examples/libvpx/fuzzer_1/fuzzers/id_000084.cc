...
extern "C" int LLVMFuzzerTestOneInput_84(const uint8_t* f_data, size_t f_size) {
  ...
  vpx_codec_enc_init_multi_ver(&encoder_ctx, encoder_iface, &encoder_cfg, fuzz_int32_t_2, fuzz_int64_t_3, nullptr, VPX_ENCODER_ABI_VERSION);
  ...
  do {
    ...
    vpx_codec_decode(&decoder_ctx, buffer, bytes_read, nullptr, fuzz_int64_t_4);
  ...
  while ((decoder_frame = vpx_codec_get_frame(&decoder_ctx, &decoder_iter)) != nullptr) {
    ...
    vpx_img_set_rect(const_cast<vpx_image_t *>(decoder_frame), fuzz_uint32_t_5, fuzz_uint32_t_6, fuzz_uint32_t_7, fuzz_uint32_t_8);

    // Encode the frame
    vpx_codec_encode(&encoder_ctx, decoder_frame, fuzz_int64_t_9, fuzz_uint64_t_10, fuzz_int64_t_11, fuzz_uint64_t_12);
  }
