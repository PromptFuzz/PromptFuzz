...
extern "C" int LLVMFuzzerTestOneInput_1(const uint8_t* f_data, size_t f_size) {
    ...
    vpx_codec_enc_init_multi_ver(NULL, vpx_codec_vp9_cx(), &enc_cfg, fuzz_int32_t_1, fuzz_int64_t_2, NULL, fuzz_int32_t_3);
    
    // Step 2: Create a libvpx encoder context
    vpx_codec_ctx_t encoder;
    vpx_codec_enc_init_ver(&encoder, vpx_codec_vp9_cx(), &enc_cfg, fuzz_int64_t_4, VPX_ENCODER_ABI_VERSION);
