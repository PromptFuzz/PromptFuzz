...
extern "C" int LLVMFuzzerTestOneInput_6(const uint8_t *data, size_t size) {
    ...
    cmsHTRANSFORM hTransform = cmsCreateProofingTransformTHR(NULL, hProfile, TYPE_RGB_8, hProfile, TYPE_RGB_8, NULL, 0, 0, 0);
    if (!hTransform) {
        assert_file_closed(&in_file);;
    ...
    cmsUInt32Number postscript_csa = cmsGetPostScriptCSA(context, hProfile, INTENT_PERCEPTUAL, 0, buffer, buffer_len);
