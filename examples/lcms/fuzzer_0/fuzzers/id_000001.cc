...
extern "C" int LLVMFuzzerTestOneInput_1(const uint8_t *data, size_t size) {
    ...
    cmsHTRANSFORM transform = cmsCreateProofingTransform(inputProfile, TYPE_RGB_8, outputProfile, TYPE_Lab_16, NULL, INTENT_PERCEPTUAL, INTENT_PERCEPTUAL, 0);
    ...
    char buffer[256];
    cmsGetProfileInfoASCII(inputProfile, cmsInfoDescription, "en", "US", buffer, sizeof(buffer));
