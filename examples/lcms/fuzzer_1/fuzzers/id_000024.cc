...
extern "C" int LLVMFuzzerTestOneInput_24(const uint8_t* f_data, size_t f_size)
{
    ...
    cmsGetProfileInfo(hProfile, cmsInfoDescription, fuzz_str_1, fuzz_str_2, buffer, MAX_BUFFER_SIZE);
    ...
    cmsUInt32Number asciiSize = cmsMLUgetASCII(mlu, fuzz_str_3, fuzz_str_4, asciiBuffer, MAX_BUFFER_SIZE);
