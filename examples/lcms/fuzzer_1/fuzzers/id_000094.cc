...
extern "C" int LLVMFuzzerTestOneInput_94(const uint8_t* f_data, size_t f_size)
{
    ...
    cmsHPROFILE profileFromFile = cmsOpenProfileFromFile("input_file", fuzz_str_1);
    ...
    cmsHPROFILE bchswAbstractProfile = cmsCreateBCHSWabstractProfile(256, 1.0, 1.0, 0.0, 1.0, fuzz_uint32_t_2, fuzz_uint32_t_3);
