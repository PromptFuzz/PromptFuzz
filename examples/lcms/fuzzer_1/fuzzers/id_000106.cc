...
extern "C" int LLVMFuzzerTestOneInput_106(const uint8_t* f_data, size_t f_size) {
    ...
    cmsNAMEDCOLORLIST* namedColorList = cmsAllocNamedColorList(context, patchCount, 0, fuzz_str_1, fuzz_str_2);
    ...
    cmsHTRANSFORM transform = cmsCreateExtendedTransform(context, 2, hProfiles, BPC, Intents, AdaptationStates, profile, fuzz_uint32_t_3, TYPE_RGB_8, TYPE_RGB_8, fuzz_uint32_t_4);
